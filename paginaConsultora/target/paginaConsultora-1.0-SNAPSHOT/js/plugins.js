...
$(document).ready(function(){
	...
	/* googleMaps Footer Map */
		...
		var latlng = new google.maps.LatLng(-34.6035681,-58.3791614); <!-- (Fist Value Longitude, Second Value Latitude), can obtain YOUR coordenates here!: http://universimmedia.pagesperso-orange.fr/geo/loc.htm -->
		var styles = [
			{
		...
		var point0 = new google.maps.LatLng(-34.6035681,-58.3791614); <!-- (Fist Value Longitude, Second Value Latitude), can obtain YOUR coordenates here!: http://universimmedia.pagesperso-orange.fr/geo/loc.htm -->
		...
		google.maps.event.addListener(marker0,'click',
		 ...
		 {content: 'Av. Corrientes 880 4&degB'});
